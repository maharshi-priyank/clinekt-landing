...
const moments = [
  ...
  },
  {
    ...
    story: 'Client accepted the proposal at 11 PM. Clinekt auto-generated the contract, sent it for signature, and queued the first invoice. By morning, the contract is signed and payment is on the way. You did nothing.',
