...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      'Clinekt staff access data only when required to resolve support issues, with your explicit consent.',
...
export default function Security() {
  useSeo(
    'Security & Privacy — Clinekt',
    'How Clinekt protects your data: AES-256 encryption, Indian servers, IT Act 2000 e-sign, DPDP Act compliance, and your rights as a user.',
  )
      ...
      <section className="py-12 px-5">
        <div className="max-w-3xl mx-auto space-y-5">
          ...
          <div className="bg-[#101828] rounded-2xl p-6 text-white">
            ...
            <a
              href="mailto:security@clinekt.io"
