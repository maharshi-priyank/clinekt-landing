...
const STORAGE_KEY = 'clinekt-hourly-rate-state'
...
export default function HourlyRateCalculator() {
  useSeo(
    'Hourly Rate Calculator for Indian freelancers — Free | Clinekt',
...
function Upsell() {
  const reasons = [
    ...
    { title: 'Project profitability, not just hours',desc: 'Clinekt shows realised hourly rate per project — accounting for time spent, expenses, and what was actually paid. The truth your gut never tells you.' },
      ...
      <div className="max-w-5xl mx-auto px-5">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight">
            ...
            <br />
            <span className="text-gray-400">Clinekt makes both effortless.</span>
          </h2>
        </div>
...
const faqs = [
  ...
  },
  {
    ...
    a: 'For client-facing quotes, almost always project-priced. Clients hate hourly because it caps your speed/efficiency at exactly what hurts them. But internally, you must know your effective hourly rate per project — that is the single number that tells you if a project was profitable. Quote project, track hours, evaluate by hour. Clinekt does this automatically.',
  },
  {
