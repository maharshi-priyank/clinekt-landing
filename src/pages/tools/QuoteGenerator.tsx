...
const STORAGE_KEY = 'clinekt-quote-gen-state'
...
export default function QuoteGenerator() {
  useSeo(
    'Free Quote / Estimate Generator for Indian Freelancers | Clinekt',
  ...
  return (
    <div className="min-h-screen bg-[#F4F6FB] pt-16">
      ...
      <section className="bg-[#101828] py-14 px-4 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-8 text-base max-w-xl mx-auto">
            Clinekt goes beyond quotes — send proposals, collect e-signatures on contracts, generate GST invoices, and collect Razorpay payments. Built for Indian freelancers.
          </p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        name: 'Free Quote Generator for Indian Freelancers — Clinekt',
        ...
        url: 'https://clinekt.io/tools/quote-generator',
      }) }} />
    </div>
  )
}
