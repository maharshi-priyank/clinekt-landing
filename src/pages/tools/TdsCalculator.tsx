...
const STORAGE_KEY = 'clearwork-tds-calc-state'
...
function Upsell() {
  const reasons = [
    { title: 'TDS auto-calculated on every invoice',     desc: 'ClearWork picks the right section and rate for your work, applies it correctly, and shows the net you\'ll actually receive — no calculator needed.' },
      ...
      <div className="max-w-5xl mx-auto px-5">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight">
            ...
            <br />
            <span className="text-gray-400">ClearWork does it on every invoice automatically.</span>
          </h2>
        </div>
