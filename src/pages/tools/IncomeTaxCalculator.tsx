...
const STORAGE_KEY = 'clinekt-income-tax-state'
...
export default function IncomeTaxCalculator() {
  useSeo(
    'Income Tax Calculator FY 2025-26 — Old vs New Regime | Clinekt',
...
function Upsell() {
  const reasons = [
    { title: 'Track GST + TDS as you earn',           desc: 'Clinekt logs every invoice and the GST + TDS breakdown. At year-end, your taxable income is already tallied — no spreadsheet archaeology.' },
      ...
      <div className="max-w-5xl mx-auto px-5">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight">
            ...
            <br />
            <span className="text-gray-400">Clinekt keeps your books clean as you work.</span>
          </h2>
        </div>
