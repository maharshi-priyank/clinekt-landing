...
const STORAGE_KEY = 'clinekt-inv-num-gen-state'
...
export default function InvoiceNumberGenerator() {
  useSeo(
    'Invoice Number Generator — Create GST-Compliant Invoice Numbers | Clinekt',
  ...
  return (
    <div className="min-h-screen bg-[#F4F6FB] pt-16">
      ...
      <section className="bg-[#101828] py-14 px-4 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-8 text-base max-w-xl mx-auto">
            Clinekt auto-assigns the next invoice number when you create an invoice — no more manual tracking. Plus GST invoicing, Razorpay payments, and client portal.
          </p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        name: 'Invoice Number Generator for Indian Freelancers — Clinekt',
        ...
        url: 'https://clinekt.io/tools/invoice-number-generator',
      }) }} />
    </div>
  )
}
