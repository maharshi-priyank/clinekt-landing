...
const STORAGE_KEY = 'clinekt-gst-calc-state'
...
// ── SEO meta-tag hook (lightweight, no react-helmet dep) ────────────────────
...
export default function GstCalculator() {
  useSeo(
    'Free GST Calculator (India) — CGST/SGST/IGST instant split | Clinekt',
...
function Upsell() {
  const reasons = [
    { title: 'Calculate AND invoice in one click',  desc: 'Skip the calculator entirely — Clinekt auto-applies GST when you generate any invoice, including the right CGST/SGST/IGST split.' },
    ...
    { title: 'Razorpay + UPI built-in',             desc: 'Send invoice with embedded payment link. Client pays via UPI, card, or net banking — and Clinekt auto-marks paid.' },
  ]
      ...
      <div className="max-w-5xl mx-auto px-5">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight">
            ...
            <br />
            <span className="text-gray-400">Clinekt does the math, the invoice, and the chase-ups.</span>
          </h2>
        </div>
...
const faqs = [
  ...
  {
    q: 'Does Clinekt do this automatically inside invoices?',
    a: 'Yes — Clinekt auto-applies GST on every invoice you create, picks CGST/SGST/IGST based on your state and the client\'s state, embeds a Razorpay UPI payment link, and ships the invoice via email + WhatsApp. There is a free plan. Sign up via the home page.',
  },
] as const
