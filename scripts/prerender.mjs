...
const ROUTES = [
  ...
  '/alternatives',
  '/alternatives/honeybook-alternative-india',
  '/alternatives/bonsai-alternative-india',
  '/alternatives/dubsado-alternative-india',
  ...
  '/blog/dubsado-alternative-india',
  ...
  '/blog/how-to-get-freelance-clients-india',
  '/blog/retainer-vs-project-pricing-agencies-india',
  '/blog/freelance-invoice-format-india',
  '/blog/gst-number-format-explained',
  '/about',
  '/contact',
  '/pricing',
]
